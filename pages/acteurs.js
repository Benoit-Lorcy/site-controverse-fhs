      ...
      <section className="section">
        <div className="container">
          ...
          <div className="card-container-acteur">
            <a className="card-acteur" href="#!">
              <div className="front" style={{ backgroundImage: "-webkit-image-set( url('/images/Frame_1.jpg') 2x)" }}>
            ...
            <a className="card-acteur" href="#!">
              <div className="front" style={{ backgroundImage: "-webkit-image-set( url('/images/Frame_2.jpg') 2x)" }}>
                <h3>Etat Français</h3>
              </div>
              <div className="back">
                <div>
            ...
            <a className="card-acteur" href="#!">
              <div className="front" style={{ backgroundImage: "-webkit-image-set( url('/images/Frame_3.jpg') 2x)" }}>
              ...
              <div className="back">
                <div>
                  <p>
                    ...
                    qu’acteurs privés, ils sont à la recherche de profits. Les choix consentis par ces entreprises vont
